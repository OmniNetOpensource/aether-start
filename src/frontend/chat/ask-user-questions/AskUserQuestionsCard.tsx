  ...
  return (
    ...
    >
      <fieldset disabled={isLocked} className='min-w-0'>
        ...
        <div className='mx-4 mt-3 gap-0 overflow-hidden rounded-md border border-border bg-background'>
          {question.options.map((option, optionIndex) => {
            ...
            return (
              <label
                ...
                className='group flex cursor-pointer items-start gap-3 border-b border-border px-3 py-2.5 transition-[background-color,box-shadow] duration-150 ease-[var(--ease-out)] hover:bg-hover data-[selected]:bg-hover data-[selected]:shadow-[inset_2px_0_0_0_var(--color-primary)]'
              >
                <input
                  type='checkbox'
                  className='sr-only'
                ...
                />
                <span className='mt-0.5 flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-border bg-background text-background group-data-[selected]:border-primary group-data-[selected]:bg-primary group-data-[selected]:text-background'>
          ...
          <label
            ...
            className='group flex cursor-pointer items-start gap-3 px-3 py-2.5 transition-[background-color,box-shadow] duration-150 ease-[var(--ease-out)] hover:bg-hover data-[selected]:bg-hover data-[selected]:shadow-[inset_2px_0_0_0_var(--color-primary)]'
          >
            <input
              type='checkbox'
              className='sr-only'
            ...
            />
            <span className='mt-0.5 flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-border bg-background text-background group-data-[selected]:border-primary group-data-[selected]:bg-primary group-data-[selected]:text-background'>
              {draft.customSelected && <Check className='h-3 w-3' strokeWidth={3} />}
            </span>
