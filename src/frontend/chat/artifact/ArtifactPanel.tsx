...
import { Braces, ChevronDown, ExternalLink, Eye, Loader2, X } from '@/frontend/design-system/icons';
import { useResponsive } from '@/frontend/app-shell/ResponsiveContext';
import { Popover, PopoverContent, PopoverTrigger } from '@/frontend/design-system/popover';
      ...
      <div className='flex shrink-0 items-center justify-between gap-3 px-1 pb-3'>
        ...
        >
          <PopoverTrigger
            asChild={(triggerProps) => (
              ...
              >
                <span className='min-w-0 font-medium text-foreground' title={artifact.title}>
          ...
          <PopoverContent className='w-64 p-1'>
            <div className='max-h-64 overflow-y-auto'>
              {artifacts.map((historyArtifact) => (
                ...
                >
                  <div className='font-medium' title={historyArtifact.title}>
        ...
        <div className='flex shrink-0 items-center gap-2'>
          {isDeploying ? (
            ...
            <a
              href={artifact.deploy_url ?? undefined}
              target='_blank'
...
export default function ArtifactPanel() {
  ...
  useEffect(() => {
    if (!artifactPanelOpen && aside.current) {
