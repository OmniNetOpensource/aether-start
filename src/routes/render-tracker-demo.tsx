...
const ForwardCounter = forwardRef<HTMLDivElement, { count: number }>(function ForwardCounter(
  ...
  return (
    <div
      ref={ref}
      className='rounded-2xl border border-sky-600 bg-sky-100 dark:bg-sky-950 p-4 text-sky-900 shadow-sm dark:text-sky-100'
    >
      ...
      <div className='mx-auto flex max-w-5xl flex-col gap-8'>
        ...
        <section className='flex flex-wrap gap-3'>
          ...
          <button
            ...
            className='rounded-full border border-slate-400 bg-slate-100 px-4 py-2 text-sm font-medium text-slate-800 transition hover:bg-white dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-900'
          >
        ...
        <section className='grid gap-4 md:grid-cols-[1.2fr_0.8fr]'>
          <div className='rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_24px_70px_#e2e8f0] backdrop-blur dark:border-slate-800 dark:bg-slate-950'>
          ...
          <div className='rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_24px_70px_#e2e8f0] dark:border-slate-800 dark:bg-slate-950 dark:shadow-[0_24px_70px_#0f172a]'>
...
function ToggleBlock({ count }: { count: number }) {
  return (
    <section className='rounded-2xl border border-amber-600 bg-amber-100 dark:bg-amber-950 p-4 text-amber-950 dark:text-amber-100'>
      <div className='text-xs uppercase tracking-[0.2em] text-amber-700 dark:text-amber-300'>
        conditional branch
      </div>
