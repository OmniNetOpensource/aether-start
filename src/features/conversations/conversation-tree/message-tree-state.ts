...
import { applyAssistantAddition, type AssistantAddition } from './block-operations';
import type { BranchInfo, ContentBlock, Message } from '@/features/chat/message-thread';
