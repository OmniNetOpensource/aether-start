/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d5c25a62c89f833941203667ccdc76c)
// Runtime types generated with workerd@1.20260317.1 2026-02-05 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server-entry");
		durableNamespaces: "ConversationRunner";
	}
	interface ProductionEnv {}
	interface Env {
		CHAT_ASSETS?: R2Bucket;
		DB?: D1Database;
		ADMIN_EMAIL_ALLOWLIST?: "sauciness_gratitude464@simplelogin.com";
		ConversationRunner?: DurableObjectNamespace<import("./server-entry").ConversationRunner>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL_ALLOWLIST">> {}
}
