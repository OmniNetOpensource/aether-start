...
export default defineConfig(({ command }) => {
  ...
  return {
    ...
    resolve: {
      ...
      alias: [
        {
          find: '@/components/AetherLogo',
          replacement: srcPath('shared/components/AetherLogo.tsx'),
        },
        {
        ...
        {
          find: '@/server/functions/notes',
          replacement: srcPath('features/notes/server/notes.ts'),
        },
        {
          find: '@/server/functions/quota',
          replacement: srcPath('features/quota/server/quota.ts'),
        },
        {
